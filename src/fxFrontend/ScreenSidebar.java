...
public class ScreenSidebar {
    ...
    private void createVarTable () {
        ...
        variableCol
                .setCellValueFactory(new PropertyValueFactory<DisplayObject, String>(VARIABLE_NAME));
        valueCol.setCellValueFactory(new PropertyValueFactory<DisplayObject, Double>(VARIABLE_VALUE));
